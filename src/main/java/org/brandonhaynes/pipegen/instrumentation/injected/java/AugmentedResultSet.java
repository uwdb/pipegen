...
public class AugmentedResultSet implements ResultSet {
    private final ResultSet resultSet;

    public static AugmentedResultSet decorate(ResultSet resultSet) {
        return new AugmentedResultSet(resultSet);
    }

    public static String decorate(ResultSet resultSet, int i) throws SQLException {
        return new AugmentedString(resultSet.getObject(i));
    }

    public static String decorate(ResultSet resultSet, String s) throws SQLException {
        return new AugmentedString(resultSet.getObject(s));
    }

    private AugmentedResultSet(ResultSet resultSet) {
